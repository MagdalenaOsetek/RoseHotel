...
namespace RoseHotel.UnitTests.Domain
{
    public class ReservationTests
    {
        ...
        Amount amount = GetValidRoom().First().Price;
        public Reservation GetValidReservation() => new Reservation(Guid.NewGuid(), GetValidRoom(), GuestTests.GetValidGuest(), DateTime.Now, DateTime.Now.AddDays(4), DateTime.Now,amount );
    }
}
